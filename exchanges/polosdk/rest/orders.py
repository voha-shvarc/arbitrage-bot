...
class Orders:
    ...
    def cancel_replace(
        self, order_id, time_in_force=None, proceed_on_failure=None, client_order_id=None, allow_borrow=None, **kwargs
    ):
        """
    ...
    def get_history(
        self, account_type=None, hide_cancel=None, start_time=None, end_time=None, begins_from=None, **kwargs
    ):
        """
