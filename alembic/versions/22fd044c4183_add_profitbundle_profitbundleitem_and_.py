...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_profit_bundles_coin_network_exchange_id"),
        "profit_bundles",
        ["coin_network_exchange_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_coin_network_exchange_can_deposit"), "coin_network_exchange", ["can_deposit"], unique=False
    )
    op.create_index(
        op.f("ix_coin_network_exchange_can_withdraw"), "coin_network_exchange", ["can_withdraw"], unique=False
    )
    op.create_index(op.f("ix_coin_network_exchange_coin_id"), "coin_network_exchange", ["coin_id"], unique=False)
    op.create_index(
        op.f("ix_coin_network_exchange_exchange_id"), "coin_network_exchange", ["exchange_id"], unique=False
    )
    op.create_index(
        op.f("ix_coin_network_exchange_network_id"), "coin_network_exchange", ["network_id"], unique=False
    )
